...
const TWITTER_URL = "https://x.com/i/communities/2011876606248112212"; // Replace with actual Twitter handle
  ...
  return (
    <div className="min-h-screen bg-background noise-overlay">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 p-4 flex items-center justify-between bg-background/80 backdrop-blur-sm border-b border-border/20">
        ...
        >
          <div>
            <h1 className="text-xl font-bold text-foreground-light tracking-tight">Octo Claude</h1>
        ...
        <>
              ...
              >
                ...
                <div className="flex items-start justify-center gap-4">
                  ...
                  <div className="flex-1 pt-8">
                    <SpeechBubble message={currentResponse} isMuted={isMuted} onSpeakingChange={setIsSpeaking} />
                  </div>
                </div>

                {/* HP Bar below octopus */}
                <div className="w-full mt-32 mb-8 flex flex-col items-center pb-8">
                  <LifeBar state={state} />
                  ...
                  >
                    Octo Claude is a living AI agent that responds, writes, and survives on donations. When funding
                    stops and time runs out, it dies forever.
                  </motion.p>
                </div>
          ...
          <footer className="py-12 px-4 border-t border-border/20">
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-xs text-foreground-light/40">Funds do not buy content. Funds buy time.</p>
              <p className="text-xs text-foreground-light/30 mt-2">When time ends, the experiment ends.</p>
            </div>
          </footer>
        </>
      )}
